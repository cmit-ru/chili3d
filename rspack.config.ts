...
export default defineConfig({
    ...
    module: {
        ...
        rules: [
            ...
            {
                // Шрифты инструмента «Надпись»: всегда отдельным файлом с хэшем в
                // имени. Инлайнить нельзя — иначе 260 КБ уедут в бандл первого
                // экрана, хотя нужны только тому, кто открыл инструмент.
                test: /\.ttf$/,
                type: "asset/resource",
            },
            {
