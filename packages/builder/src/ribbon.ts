        ...
        groups: [
            {
                ...
                items: [
                    ...
                    "create.extrude",
                    // Наверху — объёмный текст сам по себе: у него потом можно
                    // поменять и размер, и шрифт. Надпись на теле сразу вплавляется
                    // и после этого уже не редактируется — она в «Ещё».
                    "create.text",
                ],
                ...
                collapsedItems: [
                    ...
                    "create.helix",
                    "create.pipe",
                    // Надпись на теле — рабочий сценарий «подписать брелок», но
                    // после вплавления её уже не поменять, поэтому не наверху.
                    "create.textOnBody",
                ],
            },
            {
