...
export default {
    ...
    translation: {
        ...
        "command.modify.repairShape": "修复形状",
        "command.modify.simplifyShape": "简化",
        "command.modify.checkShape": "检查形状",
        ...
        "dialog.title.checkShape": "形状检查结果",
        "dialog.checkShape.valid": "有效",
        "dialog.checkShape.invalid": "无效",
        "dialog.checkShape.overallValid": "整体形状有效。",
        "dialog.checkShape.overallInvalid": "整体形状无效 — 以下面存在问题。",
        "dialog.checkShape.faceIndex": "面",
        "dialog.checkShape.validity": "有效性",
        "dialog.checkShape.noFaces": "该形状中没有面。",
        ...
        "option.command.offsetMode.pipe": "管道",
        "option.command.offsetMode.rectoVerso": "正反面",
        "option.command.offsetMode.skin": "蒙皮",
        "option.command.patternType": "阵列类型",
        "option.command.patternType.circular": "环形阵列",
        "option.command.patternType.curve": "沿曲线阵列",
        "option.command.patternType.linear": "线形阵列",
        "option.command.patternType.rectangular": "矩形阵列",
        "option.command.pitch": "螺距",
        "option.command.repeat": "重复",
        "option.command.thickness": "厚度",
        "option.command.totalLength": "总长",
        "option.rect.centerRect": "中心矩形",
        "option.text.raised": "凸起",
        "option.text.engraved": "凹陷",
        "point.position": "位置",
        "polygon.points": "点",
        "regularPolygon.sides": "边数",
        "pipe.bendRadius": "弯管半径",
        "pipe.bendType": "弯管类型",
        "navigation.ctrlMiddle": "Ctrl+中键",
        "navigation.middle": "中键",
        "navigation.shiftMiddle": "Shift+中键",
        ...
        "snapTo.center": "圆心",
        "snapTo.end": "端点",
        "snapTo.intersection": "交点",
        "snapTo.mid": "中点",
        "snapTo.more": "更多：",
        "snapTo.nearCurve": "在边线上",
        "snapTo.onSurface": "在面上",
        "snapTo.perpendicular": "垂点",
        "snapTo.tangent": "切点",
        "snapTo.title": "捕捉到：",
        "statusBar.snap": "捕捉",
